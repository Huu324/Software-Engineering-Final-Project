...
namespace saleManagement
{
    public partial class item : Form
    {
        ...
        {
            saleManagementDataSet.itemRow item = this.saleManagementDataSet.item.AdditemRow(tbIdItem.Text, tbNameItem.Text, Convert.ToInt32(txtInventory.Text));
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtInventory.Text = row.Cells[2].Value.ToString();
        }
        ...
        private void btnUpdateItem_Click(object sender, EventArgs e)
        {
            ...
            item.inventoryItem = txtInventory.Text;
        ...
        private void tbIdItem_TextChanged(object sender, EventArgs e)
        {
